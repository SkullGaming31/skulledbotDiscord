	...
	async execute(message, client) {
		...
		if (process.env.NODE_ENV === 'development') {
			...
			const row = new ActionRowBuilder().addComponents(// SkulledbotV2
				new ButtonBuilder()
					.setStyle(ButtonStyle.Link)
					.setURL('https://discord.com/api/oauth2/authorize?client_id=910935752219701258&permissions=1426936031350&redirect_uri=https%3A%2F%2Fskulledbotv2.up.railway.app%2Fapi%2Fauth%2Fdiscord%2Fredirect&response_type=code&scope=identify%20connections%20guilds%20bot%20applications.commands')
					.setLabel('Invite Me'),
				new ButtonBuilder()
					.setStyle(ButtonStyle.Link)
					.setURL('https://github.com/SkullGaming31/skulledbotDiscord/issues')
